...
* Fork the project to your GitHub account /*check*/
* Clone this project into a directory on your machine. /*check*/
* Open the code with your preferred integrated development environment (IDE). /*check*/
